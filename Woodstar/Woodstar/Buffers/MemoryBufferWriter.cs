...
sealed class MemoryBufferWriter : Stream, IStreamingWriter<byte>, ICopyableBuffer<byte>
{
    ...
    public override long Length => _currentSegment is null ? 0 : _bytesWritten;
...
#else
                await destination.WriteAsync(segment.Buffer, 0, segment.PacketSize, cancellationToken).ConfigureAwait(false);
#endif
            }
        }
